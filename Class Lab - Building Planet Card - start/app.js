    ...
    <div className="container">
      {
        props.array.map(
          planet=>
            <Planet url={planet.url} name={planet.name} desc={planet.desc}
            diameter={planet.diameter} moons={planet.moons}
            />
...
ReactDOM.render(
<Container array={planets} />,document.getElementById('root')
)
